							...
							<div class="card-footer" style="background-color: #fff;">
								<div
									...
									<div>
										...
										<span class="col-sm-6" style="text-aline:center">${funding.fundingLike}</span>
...
function remove_go(){
  ...
  heartBtn.addEventListener('click', () => {
    ...
    // 서버로 전송
    const fno = /* 게시물 번호를 JS 변수로 전달해 넣으세요 */;
    fetch(`/like/${fno}?like=${liked}`, {
      method: 'POST'
    }).then(res => res.text())
