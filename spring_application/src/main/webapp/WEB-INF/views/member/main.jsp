...
<body>
  ...
  <div class="d-flex align-items-center">
    <ul class="navbar-nav flex-row" style="font-weight: bold;">
      <li class="nav-item">
        <a href="#" class="nav-link px-4" style="color: #9B99FF;">최신</a>
      </li>
      <li class="nav-item">
        <span class="nav-link px-4" style="color: #ced4da; user-select: none;">/</span>
      </li>
      <li class="nav-item">
        <a href="#" class="nav-link px-4" style="color: #9B99FF;">인기</a>
      </li>
    </ul>
  </div>

  <!-- 중앙 검색바 -->
  <div class="d-flex justify-content-center flex-grow-1" style="margin: 0 30px;">
  ...
  <div class="col-md-2 mb-2">
    <button type="button" class="btn btn-block btn-secondary btn-lg"
      style="background-color: #9B99FF; border: none">Project Add</button>
  </div>
        ...
        <div class="card h-100"
          ...
          <div class="card-body">
            ...
            <p class="card-text" style="font-size: 0.9rem;">
              ...
              <strong>전화번호:</strong> ${member.phone}<br />
              <strong>가입일:</strong> ${regDate}
            </p>
          </div>
        </div>
      </div>
