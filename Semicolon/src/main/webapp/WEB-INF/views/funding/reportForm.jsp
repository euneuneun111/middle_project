		...
		<section class="content register-page">
			<div class="register-box">
				<form role="form" class="form-horizontal" method="post"
					...
					<input type="hidden" name="applicant" value="${loginUser.name}" />
					<input type="hidden" name="title" value="${funding.title}" /> <input
						type="hidden" name="regDate"
					...
					<div class="register-card-body">
						...
						<h4 id="target" name="title">${funding.title}</h4>
