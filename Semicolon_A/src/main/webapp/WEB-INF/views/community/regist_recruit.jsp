	  		...
	  		<div class="row md-2">
	  			...
	  			<div class="col-sm-6">
			        ...
			        <li class="breadcrumb-item">
			        	<a href="#">
				        	<i class="fa fa-dashboard"></i>홍보/모집 게시판
				        </a>
			        </li>
			...
			<div class="col-md-9" style="max-width:960px;">
				<div class="card card-outline card-info">
					...
					<div class="card-body pad">
						<form role="form" method="post" action="regist_recruit" name="registForm">
							...
							<div class="form-group">
								<label for="or_id">작성자</label> 
								<input type="text" id="or_id" title="작성자" name="or_id" class="form-control notNull" 
									readonly value="${loginUser.user_id  }"	
									/>
							</div>
							<div class="form-group">
