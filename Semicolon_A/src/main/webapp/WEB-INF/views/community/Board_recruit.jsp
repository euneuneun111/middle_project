				...
				<div class="col-md-10">
				   ...
				   <c:if test="${not empty boardList }" >		
					<c:forEach items="${boardList }" var="board">
						<tr onclick="OpenWindow('detail_recruit?rno=${board.rno}','상세보기',700,800);" style="cursor:pointer;">
							<td>${board.rno }</td>
							<td style="text-align:center; max-width: 100px; overflow: hidden; 
